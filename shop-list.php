            ...
            <div class="shop-toolbar padding-bottom-1x mb-2">
                <div class="column">
                    <div class="shop-sorting">
                        <label for="sortingL">Sort by:</label>
                        <select class="form-control" id="sortingL">
                ...
                <div class="column">
                    <div class="shop-view">
                        <a class="grid-view " href="grid-view "><span></span><span></span><span></span></a>
                        <a class="list-view active" href="#"><span></span><span></span><span></span></a>
                    </div>
                </div>
            </div>
            <!-- Products List-->
            <div class="get_list_products"></div>

            <!-- Pagination-->
            <nav class="pagination">
                <div class="column">
                    <ul class="pages page_list_no">
                ...
                <section class="widget widget-categories">
                    ...
                    <form class="price-range-slider" method="post" data-start-min="0" data-start-max="30000" data-min="0" data-max="30000" data-step="10">
                        ...
                        <footer class="ui-range-slider-footer">
                            <div class="column">
                                <button class="btn btn-outline-primary btn-sm range_filter" type="submit">Filter</button>
                            </div>
                            <div class="column">
                                <div class="ui-range-values">
                                    <div class="ui-range-value-min ">Ghc <span></span>
                                        <input type="hidden" class="min_range">
                                    </div>&nbsp;-&nbsp;
                                    <div class="ui-range-value-max ">Ghc <span></span>
                                        <input type="hidden" class="max_range">
                                    </div>
                                </div>
                            </div>
                        </footer>
